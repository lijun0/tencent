    ...
    <div class="basic-info-list__item title-bar">
      ...
      <div class="title-bar__info">
        <p class="title-bar__info-static">
          ...
          <span class="title-bar__info-item u-message"><em>2566</em>人评论</span>
        </p>
      ...
      <div class="basic-info-list__item basic-info-list__item--comment">
        <p class="basic-info-list__item-title">
          ...
          <span class="basic-info-list__item-title-static">(2)</span>
          <em class="basic-info-list__check-all">查看全部</em>
          ...
          <li class="comments-list__item">
            <div class="comments-list-item__info">
              <div class="comments-list-item__cover">
                <img class="comments-list-item__img" src="http:////q4.qlogo.cn/g?b=qq&amp;k=cDPJUHOMW15VvCR7EECmVQ&amp;s=140&amp;t=1483335362">
              </div>
              <div class="comments-list-item__name">君****</div>
              <div class="star-list__wrap">
                <div class="star-list">
                  <i class="icon-font i-comments-star no-event"></i>
                  <i class="icon-font i-comments-star no-event"></i>
                  <i class="icon-font i-comments-star no-event"></i>
                  <i class="icon-font i-comments-star no-event"></i>
                  <i class="icon-font i-comments-star no-event"></i>
            ...
            <div class="comments-list-item__comment">
                <div class="comments-list-item__content">看同事和网上的cacti搭建，很多地方都做不通，听了老师讲课，思路很清晰，还可以课后跟着老师笔记跟着做。感谢老师。</div>
                <div class="comments-list-item__progress">学习进度80%
                  <div class="comments-list-item__date">2017-06-09</div>
                </div>
              </div>
          </li>
          <li class="comments-list__item">
